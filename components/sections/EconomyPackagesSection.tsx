        ...
        <section className="py-20 flex flex-col gap-y-20">
            <div>
                <div className='container mb-16 mx-auto px-cont py-6 rounded-xl bg-brand-secondary'>
                    <h2 className="text-3xl font-bold text-white mb-12 text-center">Affordable Economy <span className="text-brand-primary">Packages</span></h2>
                ...
                <div className="px-5 flex justify-center gap-6 relative">
                    ...
                    <PackageCardSwiperContainer data={ packagesResponse.data?.packages.filter((pkg) => pkg.rating === 3 && pkg.category === 'economic') } />
